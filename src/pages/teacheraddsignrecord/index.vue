  ...
  <div class="signlist">
    <div v-for="(item, index) in tableData" :key="index">
      <div class="itemcard" @click="toSignDetail(item.id)">
        ...
        <div class="signtime" v-if="item.sign_item_type === 1">课堂签到</div>
        <div class="signtime" v-if="item.sign_item_type === 2">实验室签到</div>
  ...
  export default {
    ...
    methods: {
      ...
      getTableList() {
        ...
        wx.request({
            method: 'POST',
            url: _this.GLOBAL.baseUrl + 'sign/getTeacherAddSignRecorded',
            data: {
              page: _this.page,
              size: _this.size
            },
