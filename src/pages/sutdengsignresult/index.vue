<template>
    <div class="signdetialclass">
      <div class="classinfocard">
        ...
        <div class="signresultcoid" v-if="type === 1 && leavenum === 0">已签到</div>
        <div class="signresultcoid" v-else-if="type === 1 && leavenum > 0">已请假</div>
      </div>
      ...
      <div class="cinema-wrapper">
        ...
        <div class="seat-wrapper">
          <div class="illustration">
            ...
            <span class="illustration-text">未签到</span>
            ...
            <span class="illustration-text">已签到</span>
          </div>
          <div class="screen">
            讲台
          </div>
      ...
      <!-- <mp-dialog title="请输入签到码" :show="dialogshow" :buttons="buttons" @close="bindclose" @buttontap="buttontap">
        <input style="margin-top: 10px;" v-model="checkpass" type="digit"/>
      </mp-dialog> -->
...
<script>
    export default {
        ...
        onShow() {
          let _this = this;
          _this.type = wx.getStorageSync('accounttype');
           ...
           wx.request({
            ...
            success (res) {
              ...
              if(res.error_code === 0 ) {
                ...
                _this.leavenum = res.data.leavenum;
