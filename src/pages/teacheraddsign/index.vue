  ...
  <div class="addsign">
    <div class="newitem">
      ...
      <div class="group">
        ...
        <van-cell title="参与考勤实验室" class="content" :value="chooseItem.groupname" @click="selectGroup" is-link v-if="chooseItem.typeid === 2"/>
    ...
    <div class="savebutton">
      <van-button color="#a7a388" round block @click="subMsg">提交</van-button>
    </div>
    <!--弹出层-->
    <van-action-sheet
      :show="show"
